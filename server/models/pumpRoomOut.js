...
var PumpRoomOut = restful.model('PumpRoomOut',
  ...
  .before('get', function(req, res, next) {
    if (PumpRoomOut.lasted != null && req.query.limit === "1" && req.query.sort === "-createTime") {
      return res.status(200).json([PumpRoomOut.lasted]);
    } else {
      return next();
    }
  })
